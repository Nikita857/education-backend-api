package com.bm.education.feature.dashboard.service;
...
public class DashboardService {
    ...
    public LearnerDashboardDto getLearnerDashboard(String username) {
        ...
        long completedCourses = userCourseEnrollmentRepository.countByUserIdAndStatus(user.getId(), com.bm.education.feature.user.model.UserCourseEnrollment.EnrollmentStatus.COMPLETED); // Need to add this method
