...
import com.bm.education.feature.notification.model.Notification;
import com.bm.education.feature.offer.model.Offer;
...
@Table(name = "users",
    indexes = {
        ...
        @Index(name = "idx_user_job_title", columnList = "job_title")
    }
)
@AllArgsConstructor
@NoArgsConstructor
