package com.bm.education.feature.user.service;
...
import com.bm.education.feature.user.mapper.UserMapper;
...
public class UserService {
    ...
    public UserDto assignRoles(Long userId, List<String> roles) {
        User user = userRepository.findById(userId).orElseThrow(() -> new EntityNotFoundException("User not found: " + userId));
