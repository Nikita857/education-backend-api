package com.bm.education.dashboard.service;
...
public class DashboardService {
    ...
    private final com.bm.education.user.repository.UserCourseCompletionRepository userCourseCompletionRepository;
