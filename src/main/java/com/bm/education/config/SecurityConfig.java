...
import com.bm.education.config.filters.IpBlockingFilter;
import com.bm.education.config.jwt.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                "/login",
                                "/api/v1/auth/**",
                                "/api/v1/dev/**", // Allow dev endpoints
                                "/api/v1/auth/refresh",
                                "/register",
                                "/logout", "/logout/cookie", "/blocked", "/maintenance"
                        ).permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/courses/**", "/api/v1/modules/**", "/api/v1/lessons/**").permitAll()
